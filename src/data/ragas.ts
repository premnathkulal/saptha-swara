...
function generateMelakartaScale(melakartaNum: number): { aarohana: string; avarohana: string } {
...
const janyaRagas: RagaInfo[] = [
  {
    name: "Bhairavi", melakarta: 0, parentMelakarta: 20,
  ...
  {
    name: "Anandabhairavi", melakarta: 0, parentMelakarta: 20,
  ...
  {
    name: "Varali", melakarta: 0, parentMelakarta: 39,
  ...
  {
    name: "Hamsadhvani", melakarta: 0, parentMelakarta: 29,
  ...
  {
    name: "Arabhi", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
    famousComposition: "Sree Raghuvaraprameya (Thyagaraja)",
  },
  {
    name: "Darbar", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Neelambari", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ G₃ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
    meaning: "The blue-hued one",
  },
  {
    name: "Sindhubhairavi", melakarta: 0, parentMelakarta: 20,
    aarohana: "S R₂ G₂ M₁ P D₁ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₁ P M₁ G₂ R₂ S",
  },
  {
    name: "Desh", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ M₁ P N₃ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Purnachandrika", melakarta: 0, parentMelakarta: 29,
    aarohana: "S G₃ P D₂ Ṡ",
    avarohana: "Ṡ D₂ P G₃ R₂ S",
    meaning: "Full moon",
  },
  {
    name: "Valaji", melakarta: 0, parentMelakarta: 28,
    aarohana: "S G₃ P N₃ Ṡ",
    avarohana: "Ṡ N₃ P G₃ S",
  },
  {
    name: "Navroj", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ G₃ M₁ P M₁ D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Kedaram", melakarta: 0, parentMelakarta: 29,
    aarohana: "S M₁ G₃ M₁ P N₃ Ṡ",
    avarohana: "Ṡ N₃ P M₁ G₃ R₂ S",
  },
  {
    name: "Mukhari", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Chenchurutti", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Kurinji", melakarta: 0, parentMelakarta: 22,
  ...
  {
    name: "Saraswathi", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Vasantha", melakarta: 0, parentMelakarta: 29,
    aarohana: "S G₃ M₁ D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ M₁ G₃ R₂ S",
  ...
  {
    name: "Bhimpalas", melakarta: 0, parentMelakarta: 22,
    aarohana: "S G₂ R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Bowli", melakarta: 0, parentMelakarta: 20,
    aarohana: "S R₂ G₂ P D₂ Ṡ",
    avarohana: "Ṡ D₂ P G₂ R₂ S",
  },
  {
    name: "Huseni", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Ranjani", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ D₂ N₂ P M₁ G₂ R₂ S",
    meaning: "The delight-giving one",
  },
  {
    name: "Punnagavarali", melakarta: 0, parentMelakarta: 20,
    aarohana: "S R₁ G₂ M₁ P D₁ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₁ P M₁ G₂ R₁ S",
    famousComposition: "Sree Kamakshi (Mutthuswami Dikshitar)",
  },
  {
    name: "Lalita", melakarta: 0, parentMelakarta: 20,
    aarohana: "S R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ D₂ N₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Kokilavarali", melakarta: 0, parentMelakarta: 20,
    aarohana: "S G₂ R₂ G₂ M₁ D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Ravichandrika", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ M₁ P N₃ Ṡ",
    avarohana: "Ṡ N₃ P M₁ G₃ R₂ S",
  },
  {
    name: "Reethigowla", melakarta: 0, parentMelakarta: 22,
    aarohana: "S G₂ R₂ G₂ M₁ P D₂ P Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
    famousComposition: "Raghuvamsa Sudha (Thyagaraja)",
  },
  {
    name: "Nagaswaravali", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Sourashtram", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Manirangu", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ M₁ P N₂ Ṡ",
    avarohana: "Ṡ N₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Nalinakanti", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ G₂ M₁ P D₂ Ṡ",
    avarohana: "Ṡ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Devagandhari", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ M₁ P N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Salagabhairavi", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ G₃ M₁ P D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Kannada", melakarta: 0, parentMelakarta: 28,
    aarohana: "S G₃ M₁ D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Bahudari", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Chandrakauns", melakarta: 0, parentMelakarta: 22,
    aarohana: "S G₂ M₁ D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ M₁ G₂ S",
  },
  {
    name: "Jog", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ G₂ M₁ D₂ N₂ Ṡ",
    avarohana: "Ṡ D₂ N₂ M₁ G₂ R₂ S",
  },
  {
    name: "Kadanakuthuhalam", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ M₁ P D₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Dwijavanthi", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ M₁ P D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Paraju", melakarta: 0, parentMelakarta: 22,
    aarohana: "S R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Jhanjuti", melakarta: 0, parentMelakarta: 28,
    aarohana: "S R₂ G₃ M₁ P D₂ N₃ D₂ Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
  {
    name: "Malayamarutham", melakarta: 0, parentMelakarta: 29,
    aarohana: "S R₂ G₃ P D₂ N₃ Ṡ",
    avarohana: "Ṡ N₃ D₂ P G₃ R₂ S",
    meaning: "The gentle mountain breeze",
  },
  {
    name: "Ghanta", melakarta: 0, parentMelakarta: 20,
    aarohana: "S R₂ G₂ M₁ P D₂ N₂ Ṡ",
    avarohana: "Ṡ N₂ D₂ P M₁ G₂ R₂ S",
  },
  {
    name: "Addana", melakarta: 0, parentMelakarta: 28,
    aarohana: "S M₁ G₃ M₁ P N₃ P Ṡ",
    avarohana: "Ṡ N₃ D₂ P M₁ G₃ R₂ S",
  },
];

janyaRagas.forEach((r) => { ragaData[r.name] = r; });
...
export function searchRagas(query: string): RagaInfo[] {
  ...
  return Object.values(ragaData).filter(
    (r) => r.name.toUpperCase().includes(q)
  );
}
...
const dummySongsByRaga: Record<string, DummySong[]> = {
  ...
  Abhogi: [
    { name: "Sabhapathiki Unnade", type: "Divotional", tala: "Rupaka" },
  ],
  Kambhoji: [
  ...
  Atana: [
    { name: "Sree Raghuvara", type: "Divotional", tala: "Adi" },
  ],
  Begada: [
    { name: "Nada Loludai", type: "Divotional", tala: "Adi" },
  ],
  Saveri: [
    { name: "Intha Chalamu", type: "Divotional", tala: "Adi" },
  ],
  Nata: [
    { name: "Rara Sree Rama", type: "Divotional", tala: "Adi" },
  ],
  Keeravani: [
    { name: "Sree Krishna", type: "Divotional", tala: "Adi" },
  ],
  "Sri Ranjani": [
    { name: "Parama Pavana", type: "Divotional", tala: "Adi" },
  ],
  Varali: [
